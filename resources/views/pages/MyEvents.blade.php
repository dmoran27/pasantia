...
@section('title', 'Mi calendario de mantenimientos')
@section('content')
  ...
  <body style="background-color:#e8eeec;"> 
    <div class="box-body">
      ...
      <div class="container col-md-12" style="display:block; left:-15px; top:-25px;">
            <h3 style="text-align:right;">Mi calendario personal: {{auth()->user()->name}}</h3>
            <div id='calendar'></div>
          ...
          <div class="info-box-content " >
            <span class="">Mantenimientos completados</span>
          ...
          <div class="info-box-content " >
            <span class="">Mantenimientos preventivos</span>
        ...
        <div class="info-box bg-yellow" style="width:24%; display:inline-block; margin-top:20px;">
          ...
          <div class="info-box-content " >
            <span class="">Mantenimientos correctivos</span>
         ...
         <div class="info-box bg-red" style="width:24%; display:inline-block; margin-top:20px;">
          ...
          <div class="info-box-content " >
            <span class="">Mantenimientos Descartados</span>
      ...
      events: [
        <?php 
          foreach($eventos as $event) {
            if($event["encargado_id"] == auth()->user()->id ){
        ?>
          {
