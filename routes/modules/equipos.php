...
//equipos
	...
	Route::get('equipos/{equipo}', 'EquipoController@show')->name('equipos.show')->middleware('permission:equipos.show');

	Route::delete('equipos/{equipo}', 'EquipoController@destroy')->name('equipos.destroy')->middleware('permission:equipos.create');

	Route::get('equipos/{equipo}/edit', 'EquipoController@edit')->name('equipos.edit')->middleware('permission:equipos.edit');
